...
def serializedATN():
    return [
        ...
        3,0,2,4,0,2,2,0,1,2,13,13,1,0,3,4,44,0,7,1,0,0,0,2,11,1,0,0,0,4,
        23,1,0,0,0,6,8,3,2,1,0,7,6,1,0,0,0,8,9,1,0,0,0,9,7,1,0,0,0,9,10,
        1,0,0,0,10,1,1,0,0,0,11,12,3,4,2,0,12,13,5,11,0,0,13,3,1,0,0,0,14,
        15,6,2,-1,0,15,24,5,7,0,0,16,24,5,8,0,0,17,24,5,9,0,0,18,24,5,10,
        0,0,19,20,5,5,0,0,20,21,3,4,2,0,21,22,5,6,0,0,22,24,1,0,0,0,23,14,
        1,0,0,0,23,16,1,0,0,0,23,17,1,0,0,0,23,18,1,0,0,0,23,19,1,0,0,0,
        24,36,1,0,0,0,25,26,10,8,0,0,26,27,5,14,0,0,27,35,3,4,2,9,28,29,
        10,7,0,0,29,30,7,0,0,0,30,35,3,4,2,8,31,32,10,6,0,0,32,33,7,1,0,
        0,33,35,3,4,2,7,34,25,1,0,0,0,34,28,1,0,0,0,34,31,1,0,0,0,35,38,
        1,0,0,0,36,34,1,0,0,0,36,37,1,0,0,0,37,5,1,0,0,0,38,36,1,0,0,0,4,
        9,23,34,36
    ]
...
class SimpleLangParser ( Parser ):
    ...
    symbolicNames = [ "<INVALID>", "<INVALID>", "<INVALID>", "<INVALID>", 
                      ...
                      "STRING", "BOOL", "NEWLINE", "WS", "PERCENT", "CARET" ]
    ...
    class MulDivContext(ExprContext):
        ...
        def PERCENT(self):
            return self.getToken(SimpleLangParser.PERCENT, 0)
    ...
    class PowContext(ExprContext):
        ...
        def CARET(self):
            return self.getToken(SimpleLangParser.CARET, 0)
            ...
            while _alt!=2 and _alt!=ATN.INVALID_ALT_NUMBER:
                if _alt==1:
                    ...
                    if la_ == 1:
                        ...
                        self.state = 26
                        self.match(SimpleLangParser.CARET)
                        self.state = 27
                        self.expr(9)
                        pass
